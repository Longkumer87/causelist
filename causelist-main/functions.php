...
function getSignature($court_id)
{
    ...
    if ($court_id == 1) {
        ...
        return "Sd/-<br>Chief Judicial Magistrate & <br> Civil Judge Senior Division <br>Kohima: Nagaland";
    } elseif ($court_id == 3) {
...
function getMeetLink($court_id)
{
    ...
    if ($court_id == 1) {
        return "https://meet.google.com/jye-nhfo-hqt";
    } elseif ($court_id == 2) {
        return "https://meet.google.com/nhg-ximt-hsr";
    } elseif ($court_id == 3) {
        return "https://meet.google.com/zjy-jmmb-cbu";
    } elseif ($court_id == 4) {
        return "https://meet.google.com/yhq-wsak-jdj";
    }
    else {
        return "";
    }
...
function getMeetForm($court_id){
    return "https://forms.gle/upyvhQzwSbDuGCRw8";

}

function getDistrictLink(){
    return "https://koh.dcnlservices.in/";
}
