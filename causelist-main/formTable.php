...
<div class="container-fluid">
    <form action="save.php" method="post" onsubmit="return confirm('Are you sure you want to save?')">
        ...
        <div class="row mb-3 justify-content-center align-items-center">
            ...
            <div class="col-12 col-md-4">
                <input type="date" class="form-control" name="cause_date" id="cause_date" min="<?= date('Y-m-d'); ?>" required>
            ...
            <table class="table table-bordered table-striped" id="causeTable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><textarea class="form-control case_no" name="case_no[]" required></textarea>
                        </td>
                        <td><textarea class="form-control parties" name="parties[]"></textarea></td>
                        <td><textarea class="form-control counsel" name="counsel[]"></textarea></td>
    ...
    <textarea class="form-control" name="note" rows="3" placeholder="Type any special note or announcement here..."></textarea>
</div>

        <div class="row mb-3 mt-3">

            <!-- View Button -->
            <div class="col-12 col-md-6 text-md-start mb-2 mb-md-0 active">
